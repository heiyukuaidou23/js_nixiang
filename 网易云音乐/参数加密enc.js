      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        mI7B: function(a) {
            var c = this.i3x
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.WB9s, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createEncryptor: function(e, a) {
            return this.create(this.FT1x, e, a)
        },
        createDecryptor: function(e, a) {
            return this.create(this.brE0x, e, a)
        },
        init: function(e, a, b) {
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        mj7c: function() {
            for (var a = this.J4N, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.baP0x = d + 6) + 1), e = this.bsh0x = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.Fg1x(a, b, this.bsh0x, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.Fg1x(a, c, this.bsi0x, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        Fg1x: function(a, b, c, d, e, j, l, f) {
            for (var m = this.baP0x, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function main123(music_id){
    d = {"ids":[music_id],"level":"standard","encodeType":"aac","csrf_token":""}
    g = "0CoJUm6Qyw8W8jud"
    f = ""
    e = "010001"
    return asrsea(JSON.stringify(d), e, f, g)
}