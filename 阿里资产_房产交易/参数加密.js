...
function main123(data,timestamp){
    function p (e,data,timestamp) {
    function t(e, t) {
        return e << t | e >>> 32 - t
    }
    function n(e, t) {
    ...
    // data = {"dfApp":"auctionwalle","dfApiName":"auctionwalle.datou.getPageModulesData","dfVariables":"{\"pageId\":1410667,\"moduleIds\":\"9018433170:items\",\"context\":{\"_b_9018433170:items\":\"{\\\"spm\\\":\\\"a2129.27064540.puimod-zc-focus-2021_2860107850.category-1-1\\\",\\\"pmid\\\":\\\"0406242018_1699682775662\\\",\\\"pmtk\\\":\\\"20140647.0.0.0.27064540.puimod-zc-focus-2021_2860107850.category-1-1\\\",\\\"path\\\":\\\"27064540\\\",\\\"scm\\\":\\\"20140647.julang.360_search.brand\\\",\\\"userInfo\\\":{\\\"userId\\\":\\\"3326796581\\\"},\\\"page\\\":\\\"3\\\",\\\"appendMap\\\":{\\\"sid\\\":\\\"3366366005_1699682797554\\\"}}\",\"userInfo\":\"{}\",\"device\":\"pc\",\"sceneCode\":\"20200713C5R32B6N\"}}","dfUniqueId":"1410667.9018433170:items","dfVariablesRecover":"{}"}
    token = "36bd5d00891d801e601de423e5d7905c"
    // a = (new Date).getTime()
    s = ("12574478")
    // console.log(p(token + "&" + a + "&" + s + "&" + data))
    return p(token + "&" + timestamp + "&" + s + "&" + data)
}
