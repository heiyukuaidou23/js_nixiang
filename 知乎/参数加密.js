...
function main123(){
    ...
    location.toString = function (){
        return 'https://www.zhihu.com/topic/19555513/hot'
    }
    location.href = 'https://www.zhihu.com/topic/19555513/hot'
    var history={}
    ...
    function proxy(proxy_array){
        for (let i = 0; i < proxy_array.length; i++){
            eval(proxy_array[i] + `= new Proxy(`+proxy_array[i]+ `, {
                get(target, key){
                console.log('【`+ proxy_array[i]+`】 取属性' + key+ ' 的值: ' + target[key]);
                console.log("--------->>>>")
                return target[key];
            }
        });`)
    ...
    var proxy_array = ['window',  'navigator', 'location', 'history', 'screen', 'div','script','CanvasRenderingContext2D','document','alter','canvas'];
    proxy(proxy_array);
    ...
    !function() {
        ...
        function l(e) {
            ...
            return f_dic[e].call(c.exports, c, c.exports, l),
            c.loaded = !0,
            c.exports
        }
        l.m = s,
    ...
    return window.l(1514)['ZP']("47994e2a2a57b98d2f992bc18443a1bc");
}